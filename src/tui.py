...
class ScheduleApp(App):
    ...
    def on_list_view_selected(self, event):
        ...
        durationT_print = self.manager.from_dict(
            self.manager.session_data[event.index]
        ).total_time
...
class ConfirmDeletion(ModalScreen):
    ...
    def compose(self):
        ...
        yield Vertical(
            ...
            ListView(ListItem(Static("Yes")), ListItem(Static("No")), id="options"),
            id="dialog_container",
        )
